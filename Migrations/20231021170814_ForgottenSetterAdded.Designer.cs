...
namespace DoktormandenDk.Migrations
{
    ...
    [Migration("20231021170814_ForgottenSetterAdded")]
    partial class ForgottenSetterAdded
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("DoktormandenDk.Models.Appointment", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            AppointmentId = 1,
                            AppointmentTime = new DateTime(2023, 10, 21, 19, 8, 14, 606, DateTimeKind.Local).AddTicks(9253),
                            GPId = 1,
                            PatientId = 2,
